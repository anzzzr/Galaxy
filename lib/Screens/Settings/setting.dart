/*
 *  This file is part of Galaxy (https://github.com/5688/Galaxy).
 * 
 ...
 * along with Galaxy.  If not, see <http://www.gnu.org/licenses/>.
 * 
 * Copyright (c) 2021-2022, anzer 
 */

import 'dart:io';

import 'package:Galaxy/CustomWidgets/copy_clipboard.dart';
import 'package:Galaxy/CustomWidgets/gradient_containers.dart';
import 'package:Galaxy/CustomWidgets/popup.dart';
import 'package:Galaxy/CustomWidgets/snackbar.dart';
import 'package:Galaxy/CustomWidgets/textinput_dialog.dart';
import 'package:Galaxy/Helpers/backup_restore.dart';
import 'package:Galaxy/Helpers/config.dart';
// import 'package:Galaxy/Helpers/countrycodes.dart';
import 'package:Galaxy/Helpers/picker.dart';
import 'package:Galaxy/Helpers/supabase.dart';
import 'package:Galaxy/Screens/Home/saavn.dart' as home_screen;
import 'package:Galaxy/Screens/Settings/player_gradient.dart';
// import 'package:Galaxy/Screens/Top Charts/top.dart' as top_screen;
import 'package:Galaxy/Services/ext_storage_provider.dart';
...
class _SettingPageState extends State<SettingPage> {
  ...
  String autoBackPath = Hive.box('settings').get(
    'autoBackPath',
    defaultValue: '/storage/emulated/0/Galaxy/Backups',
  ) as String;
                        ...
                        ListTile(
                          ...
                          trailing: TextButton(
                            ...
                            onPressed: () async {
                              autoBackPath =
                                  await ExtStorageProvider.getExtStorage(
                                        dirName: 'Galaxy/Backups',
                                      ) ??
                                      '/storage/emulated/0/Galaxy/Backups';
                              Hive.box('settings')
                      ...
                      children: [
                        ...
                        ListTile(
                          ...
                          onTap: () {
                            Share.share(
                              '${AppLocalizations.of(
                                context,
                              )!.shareAppText}: https://github.com/5688/Galaxy',
                            );
                          },
                          dense: true,
                        ),
                        ListTile(
                          ...
                          onTap: () {
                            launchUrl(
                              Uri.parse(
                                'https://www.buymeacoffee.com/anzer',
                              ),
                        ...
                        ListTile(
                          ...
                          onTap: () {
                            const String upiUrl =
                                'upi://pay?pa=anzer..5688@oksbi&pn=Galaxy';
                            launchUrl(
                              Uri.parse(upiUrl),
                              mode: LaunchMode.externalApplication,
                            );
                                          ...
                                          children: [
                                            IconButton(
                                              ...
                                              onPressed: () {
                                                ...
                                                launchUrl(
                                                  Uri.parse(
                                                    'https://mail.google.com/mail/?extsrc=mailto&url=mailto%3A%3Fto%3DGalaxyyoucantescape%40gmail.com%26subject%3DRegarding%2520Mobile%2520App',
                                                  ),
                                                  mode: LaunchMode
                                                      .externalApplication,
                                                );
